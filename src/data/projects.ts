...
export const PROJECTS: Project[] = [
  {
    num: '№ 142', slug: 'riad-restaurant', title: 'Riad — Restaurant · Frankfurt · 2025', ttl: 'Riad Restaurant', meta: 'Gastronomie · Frankfurt · 2025', src: '/assets/img/proj-moroccan-dining-wide.jpg', size: 'lg', tags: ['gastro'],
    detail: {
      heroImg: '/assets/img/proj-moroccan-dining-wide.jpg',
      ...
      gallery: ['/assets/img/proj-moroccan-dining-wide.jpg', '/assets/img/proj-moroccan-corner.jpg', '/assets/img/proj-moroccan-lamps.jpg'],
    },
  },
  {
    num: '№ 138', slug: 'villa-sichtbeton', title: 'Villa Sichtbeton · Luzern · 2024', ttl: 'Villa Sichtbeton', meta: 'Wohnsitz · Luzern · 2024', src: '/assets/img/proj-concrete-sofa-tall.jpg', size: 'md', tags: ['wohnsitz'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-concrete-sofa-tall.jpg',
      ...
      gallery: ['/assets/img/proj-concrete-sofa-tall.jpg', '/assets/img/proj-concrete-corner.jpg'],
    },
  },
  {
    num: '№ 140', slug: 'kueche-eichenholz', title: 'Küche Eichenholz · Frankfurt · 2025', ttl: 'Küche Eiche', meta: 'Wohnsitz · Frankfurt · 2025', src: '/assets/img/proj-kitchen-oak.jpg', size: 'sm', tags: ['wohnsitz', 'kueche'],
    detail: {
      heroImg: '/assets/img/proj-kitchen-oak.jpg',
      ...
      gallery: ['/assets/img/proj-kitchen-oak.jpg'],
    },
  },
  {
    num: '№ 141', slug: 'spa-bad-hotel', title: 'Spa-Bad — Hotel · Emmenbrücke · 2025', ttl: 'Spa-Bad', meta: 'Hotel · Emmenbrücke · 2025', src: '/assets/img/proj-spa-bath.jpg', size: 'sm', tags: ['commercial', 'bad'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-spa-bath.jpg',
      ...
      gallery: ['/assets/img/proj-spa-bath.jpg', '/assets/img/proj-spa-corridor.jpg'],
    },
  },
  {
    num: '№ 145', slug: 'office-lobby', title: 'Office Lobby · Frankfurt · 2026', ttl: 'Office Lobby', meta: 'Commercial · Frankfurt · 2026', src: '/assets/img/proj-lobby-tree-wide.jpg', size: 'sm', tags: ['commercial'], revealDelay: 2,
    detail: {
      heroImg: '/assets/img/proj-lobby-tree-wide.jpg',
      ...
      gallery: ['/assets/img/proj-lobby-tree-wide.jpg', '/assets/img/proj-lobby-tree.jpg'],
    },
  },
  {
    num: '№ 139', slug: 'sushi-counter', title: 'Sushi Counter · Wiesbaden · 2025', ttl: 'Sushi Counter', meta: 'Gastronomie · Wiesbaden · 2025', src: '/assets/img/proj-sushi-wide.jpg', size: 'wide', tags: ['gastro'],
    detail: {
      heroImg: '/assets/img/proj-sushi-wide.jpg',
      ...
      gallery: ['/assets/img/proj-sushi-wide.jpg'],
    },
  },
  {
    num: '№ 136', slug: 'treppenhaus-sichtbeton', title: 'Sichtbeton-Treppenhaus · Luzern · 2024', ttl: 'Treppenhaus', meta: 'Commercial · Luzern · 2024', src: '/assets/img/proj-stairs-concrete.jpg', size: 'tall', tags: ['commercial'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-stairs-concrete.jpg',
      ...
      gallery: ['/assets/img/proj-stairs-concrete.jpg'],
    },
  },
  {
    num: '№ 143', slug: 'doppelbad', title: 'Doppelbad · Frankfurt · 2025', ttl: 'Doppelbad', meta: 'Wohnsitz · Frankfurt · 2025', src: '/assets/img/proj-bath-double.jpg', size: 'sm', tags: ['wohnsitz', 'bad'],
    detail: {
      heroImg: '/assets/img/proj-bath-double.jpg',
      headline: 'Doppelbad',
      ...
      gallery: ['/assets/img/proj-bath-double.jpg'],
    },
  },
  {
    num: '№ 137', slug: 'naturstein-bad', title: 'Naturstein-Bad · Sachsenhausen · 2024', ttl: 'Naturstein-Bad', meta: 'Wohnsitz · Sachsenhausen · 2024', src: '/assets/img/proj-bath-stone.jpg', size: 'sm', tags: ['wohnsitz', 'bad'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-bath-stone.jpg',
      ...
      gallery: ['/assets/img/proj-bath-stone.jpg'],
    },
  },
  {
    num: '№ 142b', slug: 'riad-bar-ecke', title: 'Riad — Bar-Ecke · Frankfurt · 2025', ttl: 'Riad Bar-Ecke', meta: 'Gastronomie · Frankfurt · 2025', src: '/assets/img/proj-moroccan-corner.jpg', size: 'md', tags: ['gastro'],
    detail: {
      heroImg: '/assets/img/proj-moroccan-corner.jpg',
      ...
      gallery: ['/assets/img/proj-moroccan-corner.jpg', '/assets/img/proj-moroccan-dining-wide.jpg'],
    },
  },
  {
    num: '№ 138b', slug: 'concrete-corner', title: 'Concrete Corner · Luzern · 2024', ttl: 'Concrete Corner', meta: 'Wohnsitz · Luzern · 2024', src: '/assets/img/proj-concrete-corner.jpg', size: 'lg', tags: ['wohnsitz'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-concrete-corner.jpg',
      ...
      gallery: ['/assets/img/proj-concrete-corner.jpg', '/assets/img/proj-concrete-sofa-tall.jpg'],
    },
  },
  {
    num: '№ 146', slug: 'wine-bar', title: 'Wine Bar · Frankfurt · 2026', ttl: 'Wine Bar', meta: 'Gastronomie · Frankfurt · 2026', src: '/assets/img/proj-wine-restaurant.jpg', size: 'sm', tags: ['gastro'],
    detail: {
      heroImg: '/assets/img/proj-wine-restaurant.jpg',
      headline: 'Wine Bar',
      location: 'Frankfurt-Innenstadt',
      year: '2026',
      area: '95 m²',
      ...
      gallery: ['/assets/img/proj-wine-restaurant.jpg'],
    },
  },
  {
    num: '№ 141b', slug: 'spa-korridor', title: 'Spa-Korridor · Emmenbrücke · 2025', ttl: 'Spa Korridor', meta: 'Hotel · Emmenbrücke · 2025', src: '/assets/img/proj-spa-corridor.jpg', size: 'sm', tags: ['commercial'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-spa-corridor.jpg',
      ...
      gallery: ['/assets/img/proj-spa-corridor.jpg', '/assets/img/proj-spa-bath.jpg'],
    },
  },
  {
    num: '№ 144', slug: 'eiche-parkett', title: 'Eiche Parkett · Wiesbaden · 2025', ttl: 'Eiche Parkett', meta: 'Wohnsitz · Wiesbaden · 2025', src: '/assets/img/photo-parkett-altbau.jpg', size: 'sm', tags: ['wohnsitz'], revealDelay: 2,
    detail: {
      heroImg: '/assets/img/photo-parkett-altbau.jpg',
      ...
      gallery: ['/assets/img/photo-parkett-altbau.jpg'],
    },
  },
  {
    num: '№ 145b', slug: 'lobby-garden', title: 'Lobby Garden · Frankfurt · 2026', ttl: 'Lobby Garden', meta: 'Commercial · Frankfurt · 2026', src: '/assets/img/proj-lobby-tree.jpg', size: 'wide', tags: ['commercial'],
    detail: {
      heroImg: '/assets/img/proj-lobby-tree.jpg',
      ...
      gallery: ['/assets/img/proj-lobby-tree.jpg', '/assets/img/proj-lobby-tree-wide.jpg'],
    },
  },
  {
    num: '№ 142c', slug: 'riad-lampen', title: 'Riad — Lampen · Frankfurt · 2025', ttl: 'Riad Lampen', meta: 'Gastronomie · Frankfurt · 2025', src: '/assets/img/proj-moroccan-lamps.jpg', size: 'tall', tags: ['gastro'], revealDelay: 1,
    detail: {
      heroImg: '/assets/img/proj-moroccan-lamps.jpg',
      ...
      gallery: ['/assets/img/proj-moroccan-lamps.jpg', '/assets/img/proj-moroccan-dining-wide.jpg'],
    },
  },
];
