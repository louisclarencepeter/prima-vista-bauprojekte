      ...
      subsections: [
        {
          ...
          products: [
            ...
            createProduct('elek-302-mat', 'material', 'material-sub', `STECKDOSE | Gira S 55 weiß |**Varianten**`, 'ELEK-302-MAT', 49.9, 'Stk', `Gira S 55 weiß |**Varianten**`, false, true, 8, 'optional'),
            createProduct('elek-301-mat', 'material', 'material-sub', `LICHTSCHALTER | Gira S 55 weiß |**Varianten**`, 'ELEK-301-MAT', 65.39, 'Stk', `Gira S 55 weiß |**Varianten**`, false, true, 2, 'optional'),
      ...
      subsections: [
        {
          ...
          products: [
            ...
            createProduct('elek-302-mat', 'material', 'material-sub', `STECKDOSE | Gira S 55 weiß |**Varianten**`, 'ELEK-302-MAT', 49.9, 'Stk', `Gira S 55 weiß |**Varianten**`, false, true, 4, 'optional'),
            createProduct('elek-301-mat', 'material', 'material-sub', `LICHTSCHALTER | Gira S 55 weiß |**Varianten**`, 'ELEK-301-MAT', 65.39, 'Stk', `Gira S 55 weiß |**Varianten**`, false, true, 1, 'optional'),
            createProduct('elek-201-2-zu-2', 'material', 'material-sub', `HERDANSCHLUSS ZULEITUNG + DOSE | 🛠 Zusatz-Montage`, 'ELEK-201-2-ZU', 391.9, 'Stk', `🛠 Zusatz-Montage`, true, false, 1, 'extra')
          ]
        }
      ...
      subsections: [
        {
          ...
          products: [
            ...
            createProduct('bode-201-op', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `VERKLEBTE BODENVERLEGUNG | 🛠 Montage-Leistungspaket`, 'BODE-201-OP', 29.9, 'qm', `🛠 Montage-Leistungspaket`, true, false, 1, 'service'),
            createProduct('bode-100-1-op', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `ALT-BODEN |🛠 Demontage & Entsorgung`, 'BODE-100-1-OP', 15.79, 'qm', `🛠 Demontage & Entsorgung`, true, false, 1, 'service')
          ]
        }
      ]
    },
      ...
      subsections: [
        {
          ...
          products: [
            ...
            createProduct('lvtdes230-4254', 'material', 'material-sub', `DESIGN 230 HDF 9,6mm/32er JOKA Classic Designböden230 HDF!`, 'LVTDES230_4254', 45.67, 'qm', `DESIGN 230 HDF 9,6mm/32er JOKA Classic Designböden230 HDF!`, true, false, 1, 'material'),
      ...
      subsections: [
        {
          ...
          products: [
            createProduct('elek-201-2-zu', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `HERDANSCHLUSS ZULEITUNG + DOSE | 🛠 Zusatz-Montage`, 'ELEK-201-2-ZU', 391.9, 'Stk', `🛠 Zusatz-Montage`, true, false, 1, 'extra'),
            createProduct('elek-301-1-zu', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `E-ZULEITUNG - ALS EINZELINSTALLATION (PRO 5 M) | 🛠 Zusatz-Montage`, 'ELEK-301-1-ZU', 159.9, 'Stk', `🛠 Zusatz-Montage`, true, false, 4, 'extra'),
            createProduct('elek-10002-basis', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `BELEUCHTUNG | 🛠 Montage-Leistungspaket`, 'ELEK-10002-Basis', 129, 'Stk', `🛠 Montage-Leistungspaket`, true, false, 1, 'service'),
            createProduct('lht-1005368', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `SLV NUMINOS® MOVE S Einbaustrahler weiß 40°`, 'LHT-1005368', 68.02, 'Stk', `SLV NUMINOS® MOVE S Einbaustrahler weiß 40°`, true, false, 1, 'material')
          ]
        }
      ]
    },
      ...
      subsections: [
        {
          ...
          products: [
            createProduct('wass-300-basis', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `WASSERINSTALLATION KÜCHE | 🛠 Montage-Leistungspaket`, 'WASS-300-BASIS', 995.9, 'Stk', `🛠 Montage-Leistungspaket`, true, false, 1, 'service'),
            createProduct('bade-503-mon', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `ARMATUR | 🛠 Montage`, 'BADE-503-MON', 190, 'Stk', `🛠 Montage`, true, false, 1, 'service'),
            createProduct('grandisehdm6', 'art-der-ausfuehrung', 'art-der-ausfuehrung-sub', `Küchen-EHM Grandis E HD-M Infrarot Batteriebetrieb 6V chrom Schell`, 'GRANDISEHDM6', 1096.92, 'Stk', `Küchen-EHM Grandis E HD-M Infrarot Batteriebetrieb 6V chrom Schell`, true, false, 1, 'material')
          ]
        }
      ]
    },
